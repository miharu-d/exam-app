...
import { useTheme, useMediaQuery } from '@mui/material'; // useMediaQuery を追加
...
export const Header = () => {
    ...
    const { isAuthenticated, user, logout } = useAuth(); // 認証状態とログアウト関数

    const [anchorEl, setAnchorEl] = useState<null | HTMLElement>(null); // モバイルメニュー用
