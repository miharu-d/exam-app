...
// 色覚異常に配慮したカラーパレットの例
// WCAG 2.1 AAA 基準のコントラスト比を意識した色を選定
// 参考: https://www.w3.org/W3C/WCAG21/Understanding/contrast-minimum.html
// https://contrastchecker.com/ などで確認すると良いでしょう

// メインカラー：落ち着いた青緑系 (学習に集中しやすい色)
const primaryMain = '#4CAF50'; // Accessible Green (例)
const primaryLight = '#81C784';
const primaryDark = '#388E3C';

// セカンダリカラー：グレー系 (情報表示や背景に使う)
const secondaryMain = '#607D8B'; // Accessible Blue-Gray (例)
